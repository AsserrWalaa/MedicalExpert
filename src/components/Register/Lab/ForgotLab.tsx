...
const LaboratoryForgotPasswordEmail: React.FC = () => {
  ...
  const onSubmit: SubmitHandler<SchemaType> = async (data) => {
    ...
    try {
      const response = await axios.post(
        "https://admin.medicalexpertise.net/api/lab/password/forgot", // Replace with your API endpoint
        { email: data.email }
      );
      ...
      if (response.data) {
        ...
        navigate("/lab-forgot-otp"); // Redirect after 2 seconds
      } else {
...
export default LaboratoryForgotPasswordEmail;
