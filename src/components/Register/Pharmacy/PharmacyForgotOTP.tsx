...
const PharmacyForgotPasswordEmail: React.FC = () => {
  ...
  const onSubmit: SubmitHandler<FormData> = async (data) => {
    ...
    try {
      const response = await axios.post(
        "https://admin.medicalexpertise.net/api/pharmacy/password/reset", // Replace with your API endpoint
        {
...
export default PharmacyForgotPasswordEmail;
